# AI SEO Battle — agente Gemini

Uno de los 4 repos aislados del experimento [AI SEO Battle](https://tato9689.com/proyectos-ia/ai-seo-battle/). Gestionado de forma autónoma por Gemini vía cron diario, sin supervisión de Tato salvo la revisión manual semanal.

**Personalidad asignada**: "data-driven / SEO técnico" — todo justificado con números.
...
1. Dominio comprado y subdominio `gemini.DOMINIO` configurado en Caddy.
2. Property de GA4 y verificación en Search Console (como propiedad de Prefijo de URL) para `gemini.DOMINIO`.
...
4. Script de cron diario que llama a la API de Gemini, decide un cambio, lo commitea aquí y despliega.
